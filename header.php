...
<head>
    ...
    <title>Swami Vivekanand Gyan Pith Sewa Samiti</title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="assets/css/module-css/up-comming.css" />
                ...
                <div class="main-menu__top-inner">
                    <ul class="list-unstyled main-menu__contact-list">
                        <li>
                            ...
                            <div class="text">
                                <p><a href="mailto:example@gamil.com">info.svgs.jharkhand@gmail.com</a>
                                </p>
                            </div>
                        </li>
                        <!-- <li>
                    ...
                    <p class="main-menu__top-text">Welcome to Swami Vivekanand Gyan Pith Sewa Samiti</p>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__right">
                            <div class="main-menu__btn-box">
                                <a href="contact.php" class="thm-btn">Donate Now</a>
                            </div>
                        </div>
                    </div>
                </div>
